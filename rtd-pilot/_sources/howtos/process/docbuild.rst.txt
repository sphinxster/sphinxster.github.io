...
These instructions will walk you through generating the |PN| Project's
documentation and publishing it to the `documentation site`_.
You can also use these instructions to generate the |PN| documentation
...
The parent folder ``project-name`` is there to make room for the
publishing area that will come later.  It's best if the ``document-repo``
